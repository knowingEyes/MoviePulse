export default function LoaderSkelenton() {
  return (
    ...
    >
      ...
      <div className="w-60 h-4 bg-gray-800/30 my-2"></div>
      <div className="[&>div]:p-5 [&>div]:bg-gray-800/30  [&>div]:mb-2 ">
        <div></div>
        <div></div>
      </div>
      <div className="[&>div]:bg-gray-800/30 [&>div]:p-2 [&>div]:mb-2">
        <div className="  w-80 "></div>
        <div className="  w-60"></div>
      </div>
      <div className="[&>div]:bg-gray-800/30  [&>div]:h-35 [&>div]:w-22 [&>div]:mb-3 mt-5">
        <div></div>
        <div></div>
        <div></div>
        <div></div>
